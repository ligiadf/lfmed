<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Adicionar atestado</li>
</ol>
<div class="row justify-content-center">
	...
	<header class="mt-4 mb-4">
		<h1>Adicionar atestado <small style="font-size: 40%;" class="badge badge-pill badge-light"><?php echo $id; ?></small></h1>
	</header>

	<?php include_once('_dados-consulta.php'); ?>

	<h5 class="mt-3 mb-3">Dados do atestado</h5>

	<form method="POST">

		<div class="form-group col-12">
			<label for="atestadoPeriodo"><i class="far fa-calendar-alt mr-1"></i> Período:</label>
			<input type="text" class="form-control" id="atestadoPeriodo" name="atestadoPeriodo" maxlength="50" required>
		...
		<div class="form-group col-12">
			...
			<textarea class="form-control" id="atestadoMotivo" name="atestadoMotivo" maxlength="100" rows="2" required></textarea>
		...
		<div class="form-group col-12 col-md-6">
			...
			<input type="text" class="form-control" id="atestadoCID" name="atestadoCID" maxlength="10">
